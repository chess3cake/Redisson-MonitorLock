 ...
 *
 */
public interface RMonitorLock extends Lock, RMonitorLockAsync {
     ...
     *
     * @param monitorId Monitor ID of locking monitor
     * @return <code>true</code> if held by thread with given id
     *          otherwise <code>false</code>
     */
    boolean isHeldByMonitor(String monitorId);


    String getHeldMonitorId();
     ...
     * otherwise <code>false</code>
     */
    boolean isHeldByCurrentMonitor();
